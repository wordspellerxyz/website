...
window.displayMailChimpStatus = function (data) {
  ...
  // Otherwise, remove the form and display the success message
  mcStatus.classList.remove('error-message');

  document.getElementById('mc-embedded-subscribe-form').style.display = 'none';
  document.getElementById('mc-status-success').textContent =
    "Thank you for joining Wordspeller's Launch List, we will remind you of our launch.";
};
...
document.addEventListener(
  'submit',
  function (event) {
    const joinListButton = document.getElementById('mc-embedded-subscribe');

    joinListButton.value = 'Adding...';
    joinListButton.style = 'cursor: not-allowed; opacity: 0.8;';
    ...
    joinListButton.value = 'Join Launch List';
    joinListButton.style = 'cursor: pointer; opacity: 1;';
  },
  false
);
